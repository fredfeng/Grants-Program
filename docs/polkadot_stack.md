...
| Hardware Wallets | [Ledger Polkadot](https://github.com/ZondaX/ledger-polkadot) :red_circle:, [Ledger Kusama](https://github.com/Zondax/ledger-kusama) :green_circle:| Trezor
...
| Gaming | [Crossbow](https://github.com/dodorare/crossbow) :red_circle:| [Amethyst](https://amethyst.rs/) + [Substrate](https://substrate.dev/)
...
| Privacy | [Webb Anon](https://github.com/webb-tools/anon) :red_circle:, [ZeroChain](https://github.com/LayerXcom/zero-chain) :red_circle:, [pLibra (Phala Network)](https://github.com/Phala-Network/phala-blockchain) :yellow_circle:, [Automata Network](https://github.com/automata-network/automata) :red_circle:, [zCloak Network](https://github.com/zCloak-Network/zcloak-node) :grey_question:, [Zero Network](https://github.com/zero-network/zero) :red_circle:|  [Multi-Asset Shielded Pool (MASP)](https://github.com/anoma/masp)<!-- NO_STATUS_BADGE --> , [Zkay](https://arxiv.org/pdf/2009.01020.pdf), [Zexe](https://eprint.iacr.org/2018/962.pdf)
